...
const DOCTOR_QUESTS = [
  ...
  { id:'mq_doctor_13', title:'데이터 분석 시약',   icon:'📊', dayTrigger:32, prerequisite:'mq_doctor_12', objective:{type:'collect_item',definitionId:'first_aid_kit',count:2},  deadlineDays:60,       reward:{morale:8} },
...
for (const r of results) {
  ...
  let info = '';
  if (r.survived) {
    info = `Q${questCompleted}/30 최종: ${lastQuest || '없음'}`;
  } else {
    info = `${r.deathCause} | Q${questCompleted}/30`;
