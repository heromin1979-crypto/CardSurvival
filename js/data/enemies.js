...
const ENEMIES = {
  ...
  raider_elite: {
    ...
    combatProfile: {
      speed: 5,
      startRank: 3,
      skillIds: ['raider_elite_basic_shot', 'raider_elite_aimed_shot'],
      skills: [
        {
          id: 'raider_elite_basic_shot',
          source: 'enemy',
          usableFrom: [1, 2, 3, 4],
  ...
  zombie_bloater: {
    ...
    combatProfile: {
      speed: 3,
      startRank: 2,
      skillIds: ['bloater_swipe', 'bloater_self_destruct'],
      skills: [
        {
          id: 'bloater_swipe',
          source: 'enemy',
        ...
        {
          id: 'bloater_self_destruct',
          source: 'enemy',
          usableFrom: [1, 2, 3, 4],
          target: { side: 'ally', ranks: [1, 2, 3, 4], count: 3 },
          accuracy: 1,
          effects: [{ type: 'damage', value: [25, 40] }],
        },
      ],
  ...
  zombie_screamer: {
    ...
    combatProfile: {
      speed: 4,
      startRank: 3,
      skillIds: ['screamer_spit', 'screamer_summon_horde'],
      skills: [
        {
          id: 'screamer_spit',
          source: 'enemy',
        ...
        {
          id: 'screamer_summon_horde',
          source: 'enemy',
          usableFrom: [2, 3, 4],
          target: { side: 'ally', ranks: [1, 2, 3, 4], count: 1 },
          accuracy: 1,
          effects: [{ type: 'damage', value: [0, 0] }],
        },
      ],
      ai: 'screamer',
    },
  ...
  zombie_charger: {
    ...
    combatProfile: {
      speed: 6,
      startRank: 1,
      skillIds: ['charger_lunge', 'charger_impact'],
      skills: [
        {
          id: 'charger_lunge',
          source: 'enemy',
        ...
        },
        {
          ...
          target: { side: 'ally', ranks: [1, 2], count: 1 },
          accuracy: 0.75,
          effects: [{ type: 'damage', value: [24, 32] }],
        },
      ],
      ai: 'charger',
    },
