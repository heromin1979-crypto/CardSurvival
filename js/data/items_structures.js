...
const ITEMS_STRUCTURES = {
  ...
  campfire: {
    ...
    tags: ['structure', 'heat', 'light', 'immovable'],   // immovable: 바닥 고정 — 드래그/배낭/스왑 불가 (분해는 클릭)
  ...
  rain_collector: {
    ...
    tags: ['structure', 'crafted', 'rain_catch'],
  ...
  gravel_pile: {
    ...
    rarity: 'common', weight: 3.0,
    defaultDurability: 40, defaultContamination: 0,
    icon: '🪨', description: '도로가 파헤쳐진 자갈 더미. 부싯돌과 텃밭에 쓸 흙을 찾을 수 있다.',
    tags: ['structure', 'salvage', 'natural'],
    dismantleTP: 1,
    dismantle: [
      { definitionId: 'firestone',  qty: 1, chance: 0.6 },
      { definitionId: 'pebble',     qty: 3, chance: 0.9 },
      { definitionId: 'soil_bag',   qty: 1, chance: 0.5 },
  ...
  water_tower: {
    ...
    defaultDurability: 200, defaultContamination: 0,
    icon: '🗼', description: '높은 곳에서 물을 저장·공급하는 탑. 날씨와 무관하게 수분을 공급한다.',
    tags: ['structure', 'building', 'crafted'],
    onTick: { hydration: 0.15 },
    dismantleTP: 3,
    dismantle: [
      { definitionId: 'scrap_metal', qty: 4, chance: 0.8 },
  ...
  plumbing_system: {
    ...
    rarity: 'rare', weight: 0,
    defaultDurability: 200, defaultContamination: 0,
    icon: '🚰', description: '정수기와 배관을 연결한 급수 체계. 날씨와 무관하게 안전한 물을 공급한다.',
    tags: ['structure', 'building', 'crafted'],
    onTick: { hydration: 0.2 },
    dismantleTP: 3,
    dismantle: [
  ...
  watchtower: {
    ...
    icon: '🗼', description: '높은 전망을 제공하는 감시 구조물. 멀리서 위험을 알아채 조우 확률 25% 감소.',
    tags: ['structure', 'defense', 'crafted'],
    onTick: { encounterReduction: 0.25 },
    dismantleTP: 4,
    dismantle: [
  ...
  rain_collector_improved: {
    ...
    rarity: 'uncommon', weight: 0,
    defaultDurability: 150, defaultContamination: 0,
    icon: '🌧️', description: '더 효율적으로 빗물을 모으는 개량형 수집기. 비가 올 때 기본형의 1.7배를 받는다.',
    tags: ['structure', 'crafted', 'rain_catch'],
  ...
  water_recycler: {
    ...
    rarity: 'legendary', weight: 0,
    defaultDurability: 200, defaultContamination: 0,
    icon: '♻️', description: '사용한 물을 정화하여 재사용하는 첨단 장치. 날씨와 무관하게 수분을 공급한다.',
    tags: ['structure', 'crafted'],
    onTick: { hydration: 0.3 },
    dismantleTP: 4,
    dismantle: [
