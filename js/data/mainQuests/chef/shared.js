...
// Q10 완료 시 분기 선택: A(강남 대형마트 식량 네트워크) vs B(용산 동료 셰프 합류)
    ...
    branchOptions: [
      {
        ...
        desc: '한강을 건너 강남 대형마트에서 대규모 식량 보급망을 구축한다.',
        setsFlag: 'chef_branch_a',
      },
      {
        label: '용산 동료 셰프 합류',
        desc: '용산에서 소피텔 동료 셰프를 찾아 전문 주방을 구축한다.',
        setsFlag: 'chef_branch_b',
      },
    ],
    narrative: {
      start: '급식소가 안정기에 접어들었다. 매일 열 명 이상이 찾아온다. 더 큰 그림을 그려야 한다.',
      complete: '식량 비축 완료. 허브차와 소금도 챙겼다. 이제 선택의 기로다. 강남 대형마트를 탐색해서 대규모 보급망을 만들 것인가, 용산에서 동료 셰프 박민호를 찾아 전문 주방을 만들 것인가.',
    },
  },
};
