    ...
    subObjectives: [
      {
        ...
        match: { type: 'collect_item_type', itemType: 'medical', count: 1 },
      },
      {
        id: 'so_d03_02',
    ...
    subObjectives: [
      {
        ...
        hint: '병원 내부 탐색 카드',
        match: { type: 'collect_item_type', itemType: 'clean', count: 1 },
      },
      {
        id: 'so_d04_02',
  ...
  mq_doctor_07: {
    ...
    subObjectives: [
      ...
      },
      {
        ...
        match: { type: 'entry_flag', key: 'prescriptionMatched' },
      },
    ],
  ...
  mq_doctor_side_early: {
    ...
    subObjectives: [
      ...
      },
      {
        ...
        match: { type: 'objective_progress', value: 3 },
      },
      {
        id: 'so_dse_03',
        text: '수첩에 임상 기록 정리',
