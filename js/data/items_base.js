...
const ITEMS_BASE = {
  ...
  rope: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🪢', description: '손목 굵기로 꼰 튼튼한 밧줄. 묶고 매고 당기는 일이라면 어디든 끼어든다.',
    tags: ['material'],
  ...
  duct_tape: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🏷️', description: '끈적임이 살아 있는 은색 테이프. 부러진 것도 일단 감아두면 버틴다.',
    tags: ['material'],
    dismantle: [],
  },
  ...
  nail: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '📌', description: '녹슬지 않은 못 한 줌. 나무든 살이든 한번 박히면 잘 빠지지 않는다.',
    tags: ['material', 'metal'],
    dismantle: [],
  },
  ...
  wire: {
    ...
    rarity: 'common', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🔌', description: '구부러지는 가는 금속 선. 전기가 흐르고, 감아 조이면 좀처럼 풀리지 않는다.',
    tags: ['material', 'metal'],
    dismantle: [],
  },
  ...
  plastic: {
    ...
    rarity: 'common', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧪', description: '깨지지 않고 물이 새지 않는 합성수지 조각. 열을 가하면 원하는 모양이 된다.',
    tags: ['material'],
    dismantle: [],
  },
  ...
  glass_shard: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '💎', description: '손대면 베일 만큼 날카로운 유리 조각. 투명하고 매끄러워 들여다보는 물건에도 쓰인다.',
    tags: ['material'],
    dismantle: [],
  },
  ...
  rubber: {
    ...
    rarity: 'common', weight: 0.3,
    defaultDurability: 100, defaultContamination: 0,
    icon: '⭕', description: '탄성이 남아 있는 고무 조각. 물을 튕겨내고 진동을 삼킨다.',
    tags: ['material'],
    dismantle: [],
  },
  ...
  leather: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🟫', description: '무두질을 마친 두꺼운 가죽. 질기고 바람을 막아 몸에 걸치는 것들에 두루 쓰인다.',
    tags: ['material'],
    dismantle: [],
  },
  ...
  empty_bottle: {
    ...
    rarity: 'common', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🍾', description: '주둥이가 좁은 유리병. 액체를 담아두기에도, 담은 채로 던지기에도 알맞다.',
  ...
  empty_can: {
    ...
    rarity: 'common', weight: 0.05,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🥫', description: '속을 비운 깡통. 얇은 금속통이라 무언가를 채워 넣기 좋다.',
    tags: ['material', 'container'],
    dismantle: [],
  },
  ...
  electronic_parts: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '💡', description: '기판에서 떼어낸 회로 부품 뭉치. 전기를 먹는 물건이라면 어딘가에 이것이 들어간다.',
    tags: ['material', 'tech'],
  ...
  spring: {
    ...
    rarity: 'uncommon', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🌀', description: '눌러도 되돌아오는 강철 스프링. 눌러 담은 힘을 한순간에 뱉어낸다.',
    tags: ['material', 'metal'],
  ...
  sharp_blade: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🗡️', description: '고철을 갈아 세운 날. 자루만 물리면 곧바로 흉기가 된다.',
  ...
  charcoal: {
    ...
    rarity: 'common', weight: 0.3,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🖤', description: '목재를 태워 만든 검은 덩어리. 불을 오래 머금고, 물의 잡내를 빨아들인다.',
  ...
  charcoal_filter: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🫙', description: '숯을 촘촘히 채워 넣은 필터. 흐린 물을 통과시키면 맑아진다.',
    tags: ['material', 'crafted'],
    dismantle: [
  ...
  alcohol_solution: {
    ...
    rarity: 'uncommon', weight: 0.3,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧴', description: '코를 찌르는 고순도 알코올. 상처를 씻어내기도 하고, 불이 아주 잘 붙기도 한다.',
  ...
  gunpowder: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '💥', description: '검은 알갱이로 뭉친 화약. 불티 하나에도 반응하니 취급에 주의.',
  ...
  thread: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🪡', description: '가늘고 질긴 실타래. 조각난 천을 다시 하나로 잇는다.',
    tags: ['material', 'textile'],
    dismantle: [],
  },
  ...
  refined_metal: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🔩', description: '용광로에서 불순물을 걷어낸 금속판. 고철과 달리 두들겨도 갈라지지 않는다.',
    tags: ['material', 'metal', 'crafted'],
  ...
  lead_ingot: {
    ...
    rarity: 'uncommon', weight: 0.5,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🔘', description: '묵직하고 무른 납 덩어리. 낮은 열에도 녹아 틀에 부어 굳힐 수 있다. 독성 주의.',
    tags: ['material', 'metal', 'crafted'],
    dismantle: [],
  },
  ...
  brass_fragment: {
    ...
    rarity: 'uncommon', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🟡', description: '구리와 납을 섞은 황동. 얇게 늘여도 찢어지지 않아 통 모양을 잡기 좋다.',
    tags: ['material', 'metal', 'crafted'],
    dismantle: [],
  },
  ...
  black_powder: {
    ...
    rarity: 'rare', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '💣', description: '숯·초석·유황을 갈아 섞은 흑색 화약. 좁은 곳에 눌러 담을수록 위력이 커진다.',
  ...
  bolt_tip: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🔺', description: '단조로 벼려낸 뾰족한 촉. 곧은 자루에 물리기 전에는 그저 쇳조각이다.',
    tags: ['material', 'metal', 'crafted'],
  ...
  herb_powder: {
    ...
    rarity: 'uncommon', weight: 0.05,
    defaultDurability: 60, defaultContamination: 0,
    icon: '🌿', description: '절구에 곱게 간 약초 가루. 잎째 쓸 때보다 훨씬 빠르게 몸에 스민다.',
  ...
  woven_fabric: {
    ...
    rarity: 'uncommon', weight: 0.3,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧵', description: '실을 촘촘히 짠 천. 일반 천보다 튼튼하지만, 한 겹 더 손대면 훨씬 질겨질 여지가 있다.',
    tags: ['material', 'textile', 'crafted'],
  ...
  dye: {
    ...
    rarity: 'common', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🎨', description: '풀과 흙에서 뽑아낸 염료. 천에 먹이면 눈에 덜 띄는 색으로 물든다.',
    tags: ['material', 'misc'],
    dismantle: [],
  },
  ...
  flour: {
    ...
    rarity: 'common', weight: 0.4,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🌾', description: '야생 밀을 빻아 만든 거친 밀가루. 물만 부으면 손에 들러붙는다.',
