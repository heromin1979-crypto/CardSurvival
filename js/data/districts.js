...
const DISTRICTS = {
  ...
  gangnam: {
    ...
    encounterChance: 0.20, noiseGen: 7,
    ...
    lootTable: [
      ...
      { definitionId: 'antiseptic',    weight: 12, minQty: 1, maxQty: 2 },
      { definitionId: 'painkiller',    weight: 10, minQty: 1, maxQty: 3 },
      { definitionId: 'gauze',         weight: 8,  minQty: 1, maxQty: 3 },
    ],
  ...
  gangdong: {
    ...
    dangerLevel: 2, travelCostTP: 2, radiation: 0,
    encounterChance: 0.20, noiseGen: 5,
  ...
  gwanak: {
    ...
    lootTable: [
      ...
      { definitionId: 'herb',          weight: 12, minQty: 1, maxQty: 3 },
  ...
  gwangjin: {
    ...
    dangerLevel: 2, travelCostTP: 2, radiation: 0,
    encounterChance: 0.10, noiseGen: 4,
    ...
    lootTable: [
      ...
      { definitionId: 'wood',          weight: 8,  minQty: 1, maxQty: 2 },
    ],
    special: null,
  },
  ...
  guro: {
    ...
    lootTable: [
      ...
      { definitionId: 'wire',          weight: 10, minQty: 1, maxQty: 3 },
  ...
  dongdaemun: {
    ...
    lootTable: [
      ...
      { definitionId: 'thread',        weight: 12, minQty: 2, maxQty: 5 },
    ],
    special: null,
  },
  ...
  seodaemun: {
    ...
    lootTable: [
      ...
      { definitionId: 'broken_lamp',   weight: 4,  minQty: 1, maxQty: 1 },
      { definitionId: 'old_generator', weight: 4,  minQty: 1, maxQty: 1 },
      { definitionId: 'antiseptic',    weight: 15, minQty: 1, maxQty: 3 },
      { definitionId: 'antibiotics',   weight: 8,  minQty: 1, maxQty: 1 },
      { definitionId: 'painkiller',    weight: 10, minQty: 1, maxQty: 2 },
    ],
    special: 'severance',
  },
  ...
  yeongdeungpo: {
    ...
    encounterChance: 0.40, noiseGen: 7,
  ...
  yongsan: {
    ...
    lootTable: [
      ...
      { definitionId: 'subway_gate',   weight: 4,  minQty: 1, maxQty: 1 },
      { definitionId: 'wrecked_bus',   weight: 4,  minQty: 1, maxQty: 1 },
      { definitionId: 'electronic_parts', weight: 20, minQty: 2, maxQty: 5 },
      { definitionId: 'wire',          weight: 10, minQty: 1, maxQty: 3 },
    ],
    special: 'us_base',
  },
  ...
  eunpyeong: {
    ...
    lootTable: [
      ...
      { definitionId: 'old_mailbox',   weight: 4,  minQty: 1, maxQty: 1 },
      { definitionId: 'rusted_toolbox', weight: 4, minQty: 1, maxQty: 1 },
      { definitionId: 'tree_log',      weight: 15, minQty: 1, maxQty: 2 },
      { definitionId: 'herb',          weight: 15, minQty: 1, maxQty: 3 },
      { definitionId: 'wood',          weight: 10, minQty: 1, maxQty: 2 },
    ],
    special: null,
  ...
  junggoo: {
    ...
    dangerLevel: 3, travelCostTP: 2, radiation: 0,
    encounterChance: 0.30, noiseGen: 6,
    ...
    lootTable: [
      ...
      { definitionId: 'destroyed_kiosk', weight: 5, minQty: 1, maxQty: 1 },
      { definitionId: 'leather',       weight: 10, minQty: 1, maxQty: 2 },
      { definitionId: 'thread',        weight: 8,  minQty: 1, maxQty: 3 },
    ],
  ...
  jungrang: {
    ...
    dangerLevel: 2, travelCostTP: 2, radiation: 0,
    encounterChance: 0.08, noiseGen: 3,
