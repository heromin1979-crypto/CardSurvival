...
export const LANDMARK_DATA = {
  ...
  seongbuk: {
    name: '고려대학교',
    desc: '명문 대학 캠퍼스. 의과대·화학과 실험실에 귀한 물자가 있을 수 있다.',
    icon: '🎓',
    subLocations: [
      {
      ...
      {
        id: 'seongbuk_library', name: '중앙도서관',
        icon: '📚', desc: '거대한 도서관. 조용하고 물자가 간간이 있다.',
        dangerMod: 0.05,
        lootTable: [
          { id: 'painkiller', weight: 2 }, { id: 'bandage', weight: 3 },
          { id: 'flashlight', weight: 2 }, { id: 'cloth', weight: 2 },
        ],
        lootCount: [1, 2],
      },
      {
        id: 'seongbuk_chemlab', name: '화학과 실험실',
        icon: '⚗️', desc: '약품과 시약이 남아 있는 실험실.',
        dangerMod: 0.25,
        lootTable: [
          { id: 'antiseptic', weight: 3 }, { id: 'rad_blocker', weight: 2 },
          { id: 'antidote', weight: 2 }, { id: 'plastic', weight: 2 },
        ],
        lootCount: [1, 3],
      },
      {
        id: 'seongbuk_dorm', name: '기숙사',
        icon: '🛏️', desc: '학생 기숙사. 일상 생존 물자가 남아있을 수 있다.',
        dangerMod: 0.10,
        lootTable: [
      ...
      {
        id: 'seongbuk_lib_basement', name: '도서관 지하 서고',
  ...
  nowon: {
    name: '불암산 자연공원',
    desc: '서울 북동쪽 자연공원. 약수터와 야생 허브가 풍부하다.',
    icon: '🌳',
    subLocations: [
      {
        id: 'nowon_trail', name: '자연 관찰로',
        icon: '🛤️', desc: '야생 약초가 자라는 탐방로.',
        dangerMod: 0.05,
        lootTable: [
          { id: 'vitamins', weight: 6 }, { id: 'wood', weight: 3 },
          { id: 'rope', weight: 2 },
        ],
        lootCount: [2, 4],
      },
      {
        id: 'nowon_spring', name: '약수터',
        icon: '💧', desc: '등산로 약수터. 신선한 물을 구할 수 있다.',
        dangerMod: 0.05,
        lootTable: [
          { id: 'purified_water', weight: 5 }, { id: 'contaminated_water', weight: 1 },
          { id: 'vitamins', weight: 3 },
        ],
        lootCount: [2, 4],
      },
      {
        id: 'nowon_campsite', name: '숲 캠핑지',
        icon: '🏕️', desc: '방치된 캠핑장. 생존 도구들이 남아있다.',
        dangerMod: 0.15,
        lootTable: [
          { id: 'wood', weight: 4 }, { id: 'rope', weight: 3 },
          { id: 'flashlight', weight: 2 }, { id: 'bandage', weight: 2 },
        ],
        lootCount: [2, 3],
      },
      {
        id: 'nowon_wildlife', name: '야생동물 서식지',
        icon: '🦌', desc: '동물 서식지. 가죽 재료를 얻을 수 있지만 위험하다.',
        dangerMod: 0.30,
        lootTable: [
          { id: 'leather', weight: 4 }, { id: 'rope', weight: 2 },
          { id: 'bandage', weight: 2 }, { id: 'knife', weight: 1 },
        ],
        lootCount: [1, 3],
      },
      {
        id: 'nowon_observatory', name: '전망대',
        icon: '🔭', desc: '산 정상 전망대. 주변 상황을 파악할 수 있다.',
        dangerMod: 0.10,
        lootTable: [
          { id: 'flashlight', weight: 3 }, { id: 'bandage', weight: 2 },
