...
const LEGENDARY_ITEMS = {
  ...
  ammo_press: {
    ...
    icon: '⚙️', description: '탄피에 화약과 탄두를 눌러 담는 프레스. 설치해 두면 탄약을 직접 찍어낼 수 있다.',
    tags: ['tool', 'legendary'],
  ...
  colossus_core: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '💎', description: '거대 변이체의 심장부에서 꺼낸 핵. 손바닥에 열이 전해질 만큼 아직 살아 있다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  acid_gland: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🫧', description: '산성 변이체에서 적출한 분비선. 주머니 안쪽이 아직도 무언가를 녹이고 있다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  horde_crown: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '👑', description: '좀비 무리의 우두머리가 쓰고 있던 뒤틀린 뼈관. 가까이 두면 다른 개체들이 술렁인다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  cryo_core: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧊', description: '냉기 변이체에서 꺼낸 핵. 맨손으로 쥐면 살이 들러붙을 만큼 차갑다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  cult_talisman: {
    ...
    rarity: 'rare', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🔮', description: '교주가 목에 걸고 있던 부적. 새겨진 문양이 어느 글자와도 닮지 않았다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },

  // 조우 감소는 보드에 올려둔 카드의 onUse를 ExploreSystem._collectToolEffects가 집계한다.
  // armor의 onWear.encounterReduction은 읽는 곳이 없어 도구 형태로 만든다.
  warding_charm: {
    id: 'warding_charm', name: '수호 부적', type: 'tool', subtype: 'utility',
    rarity: 'rare', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '📿', description: '교주의 부적을 풀어 다시 엮은 물건. 지니고 있으면 무언가가 가까이 오기를 꺼린다.',
    tags: ['tool', 'utility'],
    onUse: { encounterReduction: 0.12 },
    dismantle: [
      { definitionId: 'cult_talisman', qty: 1, chance: 0.5 },
      { definitionId: 'thread', qty: 1, chance: 0.7 },
    ],
  },
  ...
  tiger_fang: {
    ...
    rarity: 'rare', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🦷', description: '변이 호랑이의 송곳니. 끝이 조금도 닳지 않았고, 뿌리 쪽에 구멍을 뚫기 좋다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  sewer_scale: {
    ...
    rarity: 'rare', weight: 0.5,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🐊', description: '하수도 악어에서 벗겨낸 비늘. 겹쳐 대면 칼끝이 미끄러진다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  conductor_key: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🗝️', description: '지하철 차장이 지니던 마스터키. 승무원 전용 구역의 자물쇠가 모두 같은 규격이었다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  ai_chip: {
    ...
    rarity: 'rare', weight: 0.05,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🤖', description: '군용 드론에서 뜯어낸 연산 칩. 전원을 끊었는데도 표면이 미지근하다.',
  ...
  mutant_heart: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '❤️‍🔥', description: '강력한 변이체의 심장. 아직 미약하게 뛰고 있고, 조직이 이상하리만치 질기다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  inferno_core: {
    ...
    defaultDurability: 100, defaultContamination: 0,
    icon: '🌋', description: '화염 변이체에서 꺼낸 발열 핵. 물에 담가도 김만 오를 뿐 식지 않는다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  acid_crystal: {
    ...
    rarity: 'rare', weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '💚', description: '체내에서 굳어버린 산 결정. 이것에 절인 천은 산을 튕겨낸다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  doctor_badge: {
    ...
    rarity: 'rare', weight: 0.05,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🏅', description: '감염된 군의관이 지니고 있던 배지. 이름 각인 위로 마른 핏자국이 덮여 있다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  engineer_gear: {
    ...
    rarity: 'rare', weight: 0.4,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🛠️', description: '군 공병대의 정밀 장비 일습. 손때가 묻었지만 눈금 하나 흐려지지 않았다.',
    tags: ['material', 'boss_drop'],
  ...
  firefighter_badge: {
    ...
    rarity: 'rare', weight: 0.05,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🚒', description: '감염된 동료 이재훈이 달고 있던 배지. 불길을 몇 번이나 지나고도 형태가 온전하다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  mutant_formula: {
    ...
    rarity: 'rare', weight: 0.1,
    defaultDurability: 100, defaultContamination: 0,
    icon: '📝', description: '변이 셰프가 남긴 조제법. 알아볼 수 없는 기호 사이에 의료용 배합이 섞여 있다.',
    tags: ['material', 'boss_drop'],
    dismantle: [],
  },
  ...
  kevlar_fabric: {
    ...
    rarity: 'rare', weight: 0.4,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧵', description: '총알을 붙잡도록 짜인 특수 직물. 겹칠수록 무거워지지만 그만큼 든든하다.',
  ...
  master_forge: {
    ...
    defaultDurability: 500, defaultContamination: 0,
    icon: '🔨', description: '노의 온도가 다른 대장간. 여느 화덕으로는 녹지 않던 금속까지 다룰 수 있다.',
  ...
  field_laboratory: {
    ...
    rarity: 'legendary', legendary: true, weight: 0,
    defaultDurability: 400, defaultContamination: 0,
    icon: '🔬', description: '의사만이 꾸릴 수 있는 야전 연구실. 정밀한 의료 작업이 가능해지고 손끝이 덜 흔들린다. 제작 성공률 30% 상승.',
  ...
  directional_mine: {
    ...
    onConsume: { deployTrap: 'deployed_mine' },
    dismantle: [],
  },

  // 설치된 지뢰 — 바닥(middle)에 놓이며, 바닥은 장소별로 보존된다(ExploreSystem.locationFloors).
  // 그래서 설치한 곳을 떠나면 발동하지 않고, 돌아오면 다시 작동한다.
  // 발동 시 내구도 10을 잃고(TRAP_DURABILITY_COST) 사라지므로 1회용이다.
  deployed_mine: {
    id: 'deployed_mine', name: '설치된 지뢰', type: 'structure', subtype: 'trap',
    rarity: 'legendary', weight: 1.0,
    defaultDurability: 10, defaultContamination: 0,
    icon: '💥', description: '기폭 장치를 세워둔 지뢰. 다음에 이곳에서 싸움이 붙으면 한 번 터진다.',
    tags: ['structure', 'trap', 'explosive'],
    onTrigger: { damage: 35 },
    dismantleTP: 1,
    dismantle: [],
  },
  ...
  immunity_serum: {
    ...
    rarity: 'legendary', legendary: true, weight: 0.2,
    defaultDurability: 100, defaultContamination: 0,
    icon: '🧪', description: '셰프 전용 면역 혈청. 감염 완전 제거, 영구 감염 면역, 질병 저항 50%.',
    tags: ['medical', 'legendary', 'chef'],
