...
const SUPPORT_EFFECTS = {
  doctor_diagnose: { type: 'token', token: 'vulnerable', amount: 1 },
  ...
  child_warning: { type: 'token', token: 'dodge', amount: 1 },
  ...
  dog_track_weakness: { type: 'token', token: 'vulnerable', amount: 1 },
  colleague_brace: { type: 'guard', value: 0.3 },
  colleague_teamwork: { type: 'token', token: 'accuracy', amount: 1 },
  minjun_command: { type: 'stress', value: -10 },
  sohee_silent_cover: { type: 'guard', value: 0.25 },
  sohee_focus: { type: 'token', token: 'focus', amount: 1 },
  jisu_diagnose: { type: 'token', token: 'vulnerable', amount: 1 },
  yeongcheol_rally: { type: 'stress', value: -14 },
  daehan_barricade: { type: 'guard', value: 0.4 },
  daehan_overcharge: { type: 'token', token: 'power', amount: 1 },
  security_guard: { type: 'guard', value: 0.4 },
  security_taunt: { type: 'token', token: 'taunted', amount: 1 },
  merchant_bargain: { type: 'token', token: 'hesitation', amount: 1 },
  tower_engineer_cover: { type: 'guard', value: 0.35 },
  tower_engineer_trap: { type: 'status', status: { id: 'rooted', duration: 1, chance: 0.65 } },
  tower_doctor_stimulant: { type: 'token', token: 'speed', amount: 1 },
