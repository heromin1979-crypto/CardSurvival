...
export const CHAR_DIALOGUES = {
  ...
  chef: {
    useBandage:    '"칼에 베인 건 익숙하지." 재혁이 능숙하게 감았다.',
    useAntiseptic: '"위생이 기본이야." 재혁은 소독부터 하는 습관이 있었다.',
    useMedicine:   '"몸이 재료야. 관리해야지." 재혁이 약을 삼켰다.',
    useFirstAid:   '셰프의 손은 빠르고 정확했다. 주방에서 단련된 응급처치.',
    exploreLab:    '"쓸 만한 식재료가 있을지도." 재혁이 안을 살폈다.',
    explorePharmacy: '"비타민이라도 있으면 좋겠는데." 재혁이 선반을 훑었다.',
    exploreEmpty:  '"빈손이어도 다음을 위해 기억해둬야 해." 재혁이 주변을 살폈다.',
    combatStart:   '"칼은 익숙하지. 주방 칼이든 뭐든." 재혁이 자세를 낮췄다.',
    combatCrit:    '뼈와 관절 사이를 정확히 노린다. 해체 전문가니까.',
    combatFlee:    '"오늘의 메뉴는 여기서 끝이야." 재혁이 달렸다.',
    combatWin:     '"다친 데 없어? 밥부터 먹자." 재혁이 주위를 살폈다.',
