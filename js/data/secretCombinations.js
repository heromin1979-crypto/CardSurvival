...
const SECRET_COMBINATIONS = [
...

  {
    id: 'sc_defense_salve',
    name: '방어 연고',
    source: { id: 'herb_powder' },
    target: { id: 'bandage' },
    hint: '약초 가루를 붕대에 바르면...',
    discoveryMsg: '💡 방어 연고! 피부 보호 효과가 생겼다.',
    xpReward: { skill: 'defense', amount: 15 },
    requiredSkill: { defense: 2 },
    result: {
      spawnItem: 'defense_salve',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
  {
    id: 'sc_shield_mod',
    name: '방패 개조',
    source: { id: 'steel_plate' },
    target: { tag: 'armor' },
    hint: '강철판을 방어구에 덧대면...',
    discoveryMsg: '💡 방패 개조! 방어력이 강화됐다.',
    xpReward: { skill: 'defense', amount: 20 },
    requiredSkill: { defense: 5 },
    result: {
      addEffect: { defense: 5 },
      consumeSrc: true,
      consumeTgt: false,
  ...
  {
    id: 'sc_guard_stance_kit',
    name: '방어 자세 키트',
    source: { id: 'leather' },
    target: { id: 'rope' },
    hint: '가죽끈으로 방어 자세를 잡으면...',
    discoveryMsg: '💡 방어 자세 키트! 가드 효율이 올랐다.',
    xpReward: { skill: 'defense', amount: 25 },
    requiredSkill: { defense: 7 },
    additionalReq: [{ id: 'rope', qty: 1 }],
    result: {
      spawnItem: 'guard_stance_kit',
      consumeSrc: true,
      consumeTgt: true,
      consumeExtra: true,
    },
  },
  {
    id: 'sc_fortress_mod',
    name: '요새화 개조',
    source: { id: 'reinforced_wall' },
    target: { tag: 'armor' },
    hint: '강화 벽 근처에서 방어구를 보강하면...',
    discoveryMsg: '💡 요새화 개조! 최강의 방어.',
    xpReward: { skill: 'defense', amount: 30 },
    requiredSkill: { defense: 12 },
    result: {
      addEffect: { defense: 10, damageReduction: 0.05 },
      consumeSrc: false,
      consumeTgt: false,
    },
  },
...

  {
    ...
    target: { id: 'cloth' },
    hint: '천으로 주먹을 감으면...',
    discoveryMsg: '💡 너클 랩! 맨손 데미지가 증가한다.',
    xpReward: { skill: 'unarmed', amount: 15 },
    requiredSkill: { unarmed: 3 },
    result: {
      spawnItem: 'knuckle_wrap',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
  {
    id: 'sc_combat_gloves',
    name: '전투 장갑',
    source: { id: 'reinforced_fabric' },
    target: { id: 'leather' },
    hint: '강화 천과 가죽으로 장갑을 만들면...',
    discoveryMsg: '💡 전투 장갑! 강력한 주먹.',
    xpReward: { skill: 'unarmed', amount: 20 },
    requiredSkill: { unarmed: 5 },
    result: {
      spawnItem: 'combat_gloves',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
  {
    ...
    name: '철권 건틀릿',
    source: { id: 'scrap_metal' },
    target: { id: 'combat_gloves' },
    hint: '금속으로 장갑을 보강하면...',
    discoveryMsg: '💡 철권 건틀릿! 주먹이 흉기다.',
    xpReward: { skill: 'unarmed', amount: 25 },
    requiredSkill: { unarmed: 8 },
    result: {
      spawnItem: 'iron_gauntlet',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
...

  {
    ...
    target: { tag: 'melee' },
    hint: '돌로 칼날을 갈면...',
    discoveryMsg: '💡 날 갈기! 무기가 더 날카로워졌다.',
    xpReward: { skill: 'melee', amount: 15 },
    requiredSkill: { melee: 2 },
    result: {
      addEffect: { sharpness: 3 },
      consumeSrc: true,
      consumeTgt: false,
    },
  },
  {
    ...
    source: { id: 'herb' },
    target: { id: 'rubber' },
    hint: '약초와 고무로 기름을 만들어 바르면...',
    discoveryMsg: '💡 검유! 무기 내구도 감소가 줄었다.',
    xpReward: { skill: 'melee', amount: 15 },
    requiredSkill: { melee: 4 },
    result: {
      spawnItem: 'weapon_oil',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
  {
    ...
    target: { tag: 'melee' },
    hint: '못을 무기에 박으면...',
    discoveryMsg: '💡 톱니 개조! 출혈 효과가 추가됐다.',
    xpReward: { skill: 'melee', amount: 20 },
    requiredSkill: { melee: 6 },
    additionalReq: [{ id: 'wire', qty: 1 }],
    result: {
      spawnItem: 'serrated_mod',
      consumeSrc: true,
      consumeTgt: false,
      consumeExtra: true,
    },
  },
  {
    ...
    target: { id: 'campfire' },
    hint: '무기를 불에 달구면...',
    discoveryMsg: '💡 무기 담금질! 강도가 올랐다.',
    xpReward: { skill: 'melee', amount: 20 },
    requiredSkill: { melee: 8 },
    result: {
      addEffect: { damage: 5 },
      consumeSrc: false,
      consumeTgt: false,
...

  {
    ...
    target: { tag: 'ranged' },
    hint: '고철을 탄약에 섞으면...',
    discoveryMsg: '💡 탄약 개조! 관통력이 증가했다.',
    xpReward: { skill: 'ranged', amount: 15 },
    requiredSkill: { ranged: 3 },
    result: {
      spawnItem: 'ammo_mod',
      consumeSrc: true,
      consumeTgt: false,
  ...
  },
  {
    id: 'sc_weapon_scope',
    name: '조준경 장착',
    source: { id: 'glass_shard' },
    target: { tag: 'ranged' },
    hint: '유리로 조준경을 만들면...',
    discoveryMsg: '💡 조준경 장착! 정확도가 크게 올랐다.',
    xpReward: { skill: 'ranged', amount: 20 },
    requiredSkill: { ranged: 5 },
    additionalReq: [{ id: 'wire', qty: 1 }],
    result: {
  ...
  },
  {
    ...
    target: { id: 'rubber' },
    hint: '파이프와 고무로...',
    discoveryMsg: '💡 소음기! 발사 소음이 줄었다.',
    xpReward: { skill: 'ranged', amount: 20 },
    requiredSkill: { ranged: 7 },
    result: {
      spawnItem: 'suppressor',
      consumeSrc: true,
      consumeTgt: true,
    },
  },
  {
    ...
    source: { id: 'scrap_metal' },
    target: { id: 'spring' },
    hint: '금속과 스프링으로 탄창을 늘리면...',
    discoveryMsg: '💡 확장 탄창! 장탄수가 증가했다.',
    xpReward: { skill: 'ranged', amount: 30 },
    requiredSkill: { ranged: 12 },
    result: {
      addEffect: { ammoCapacity: 2 },
      consumeSrc: true,
      consumeTgt: true,
    },
  },
